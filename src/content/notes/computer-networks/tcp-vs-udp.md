...
You now understand both major Transport Layer protocols:
...
This completes the **Transport Layer** concepts.

The next logical topic from your Notion is **OSI Model & TCP/IP Model**, where we'll finally answer:

- Why do networking layers exist?
- What is the OSI model?
- What is the TCP/IP model?
- Where do TCP and UDP fit?
- Which layers do backend engineers actually work with?

Now that you know the protocols, those models will make much more sense than if we had started with them.
